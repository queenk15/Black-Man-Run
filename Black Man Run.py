...
LITE_PURPLE = (232, 206, 227)

# Fonts
FONT_SM = pygame.font.Font("fonts/VIDEOPHREAK.ttf", 32)
FONT_MD = pygame.font.Font("fonts/VIDEOPHREAK.ttf", 64)
FONT_LG = pygame.font.Font("fonts/VIDEOPHREAK.ttf", 72)
...
# Images
hero_walk1 = load_image("assets/Black man/walk/front 0002.png")
hero_walk2 = load_image("assets/Black man/walk/front 0003.png")
hero_jump = load_image("assets/Black man/jump/front 0004.png")
hero_idle = load_image("assets/Black man/idle/front 0000.png")
hero_images = {"run": [hero_walk1, hero_walk2],
               "jump": hero_jump,
               "idle": hero_idle}

block_images = {"LB": load_image("assets/PNG/forest_pack_03.png"),
                "MB": load_image("assets/PNG/forest_pack_05.png"),
                "RB": load_image("assets/PNG/forest_pack_07.png"),
                "FR": load_image("assets/PNG/forest_pack_11.png"),
                "FL": load_image("assets/PNG/forest_pack_09.png"),
                "CL": load_image("assets/PNG/cloud.png"),
                "FS": load_image("assets/PNG/forest_pack_39.png"),
                "SB": load_image("assets/PNG/forest_pack_34.png")}

coin_img = load_image("assets/Coin/Coin.png")
heart_img = load_image("assets/Heart/heart.png")
oneup_img = load_image("assets/Powerups/colorbomb1.png")
flag_img = load_image("assets/Flag/flag.png")
flagpole_img = load_image("assets/Flag/flagpole.png")

enemy2_img1 = load_image("assets/monster worm/6.png")
enemy2_img2 = load_image("assets/monster worm/5.png")
enemy2_images = [enemy2_img1, enemy2_img2]

enemy1_img = load_image("assets/Transparent PNG/8.png")
enemy1_images = [enemy1_img]

# Sounds
JUMP_SOUND = pygame.mixer.Sound("Music/jump.wav")
COIN_SOUND = pygame.mixer.Sound("Music/pickup_coin.wav")
POWERUP_SOUND = pygame.mixer.Sound("Music/powerup.wav")
HURT_SOUND = pygame.mixer.Sound("Music/hurt.ogg")
DIE_SOUND = pygame.mixer.Sound("Music/death.wav")
LEVELUP_SOUND = pygame.mixer.Sound("Music/level_up.wav")
GAMEOVER_SOUND = pygame.mixer.Sound("Music/game_over.wav")
...
class Level():
    ...
    def __init__(self, file_path):
        ...
        for item in map_data['enemy1']:
            x, y = item[0] * GRID_SIZE, item[1] * GRID_SIZE
            self.starting_enemies.append(Enemy1(x, y, enemy1_images))

        for item in map_data['enemy2']:
            x, y = item[0] * GRID_SIZE, item[1] * GRID_SIZE
            self.starting_enemies.append(Enemy2(x, y, enemy2_images))
...
class Game():
    ...
    def display_splash(self, surface):
        ...
        line2 = FONT_SM.render("Press any key to start. Good Luck!", 1, WHITE)
    ...
    def draw(self):
        ...
        if self.stage == Game.SPLASH:
            ...
            self.display_message(self.window, "Ready?!!!", "Press any key to start. Good Luck!")
        elif self.stage == Game.PAUSED:
            self.display_message(self.window, "The Game is now paused", "Press P to continue")
        elif self.stage == Game.LEVEL_COMPLETED:/
